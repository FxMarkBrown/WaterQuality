...
from trainers.LSTMTrainer import LSTMModel
from tuners.BaseTunner import BaseTuner


class LSTMBayesianOptimizationTuner(BaseTuner):
    """
    LSTM贝叶斯优化调优
    """
    ...
    def tune(self, X, y):
        """ 执行贝叶斯优化 """
        print(f"开始LSTM贝叶斯优化调优（最大评估{self.max_evals}次）")
